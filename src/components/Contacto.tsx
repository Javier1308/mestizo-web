    ...
    <section id="contacto" className="relative py-20 bg-brown overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6">
        ...
        <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <a
            href="https://linktr.ee/MestizoRestobar"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 border-2 border-cream text-cream font-bold text-lg px-10 py-4 rounded-full hover:bg-cream hover:text-brown transition-colors shadow-lg"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
            </svg>
            Visita nuestro Linktree
          </a>
        </div>
      </div>
    </section>
